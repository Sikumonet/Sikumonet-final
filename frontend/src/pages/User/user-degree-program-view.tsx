...
import { getSingleDegreeProgram } from "../../API/DegreePrograms/degree-programs-api.service";
...
export default function UserDegreeProgramView() {
  useScrollToTop();
        ...
        <div className="grid grid-cols-5 gap-3">
          {academicYearsData
            ...
            .map((item: any, index: any) => (
              <Link
                to={`${VIEWS.USER_ACADEMIC_YEAR_VIEW}?id=${item._id}`}
