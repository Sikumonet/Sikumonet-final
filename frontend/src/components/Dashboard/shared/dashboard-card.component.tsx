...
export default function DashboardCardComponent(props: {
  ...
  return (
    <React.Fragment>
      <div className="flex flex-col items-center justify-center p-6 bg-blue-100 hover:bg-blue-50 rounded-xl shadow-sm">
        <i
          className={`${props.icon} text-4xl font-bold text-slate-800 text-center`}
        ></i>
